...
import { standardUpdate } from '../utils/mongoHelpers';
import { 
  withErrorHandling, 
  sendError, 
  sendSuccess, 
...
// Create booking
export const create = withErrorHandling(async (req: AuthenticatedRequest, res: Response): Promise<void> => {
...
export const getAll = withErrorHandling(async (req: Request, res: Response) => {
...
// Get booking by ID
export const getById = withErrorHandling(async (req: AuthenticatedRequest, res: Response): Promise<void> => {
...
// Update booking
export const update = withErrorHandling(async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  if (!validateRequiredId(req.params.id, res, 'Booking ID')) {
    return;
  }
...
export const deleteBooking = withErrorHandling(async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  if (!validateRequiredId(req.params.id, res, 'Booking ID')) {
    return;
  }
