  ...
  describe('User Management', () => {
    ...
    describe('updateUserRole', () => {
      it('should update user role successfully', async () => {
        ...
        const updatedUser = await AdminService.updateUserRole(String(user._id), 'VALET');
    ...
    describe('deleteUser', () => {
      it('should delete user successfully when no active bookings', async () => {
        ...
        await AdminService.deleteUser(String(user._id));
      ...
      it('should throw error when user has active bookings', async () => {
        ...
        await expect(
          AdminService.deleteUser(String(user._id))
        ).rejects.toThrow(AppError);
      });
    });
  });
  ...
  describe('Valet Management', () => {
    ...
    describe('updateValet', () => {
      it('should update valet profile successfully', async () => {
        ...
        const updatedValet = await AdminService.updateValet(String(valet._id), updateData);
    ...
    describe('deleteValet', () => {
      it('should delete valet successfully', async () => {
        ...
        await AdminService.deleteValet(String(valet._id));
  ...
  describe('Location Management', () => {
    ...
    describe('updateLocation', () => {
      it('should update location successfully', async () => {
        ...
        const updatedLocation = await AdminService.updateLocation(String(location._id), updateData);
      ...
      it('should throw error for invalid coordinates in update', async () => {
        ...
        await expect(
          AdminService.updateLocation(String(location._id), updateData)
        ).rejects.toThrow(AppError);
      });
    ...
    describe('deleteLocation', () => {
      it('should delete location successfully when no active bookings', async () => {
        ...
        await AdminService.deleteLocation(String(location._id));
      ...
      it('should throw error when location has active bookings', async () => {
        ...
        await expect(
          AdminService.deleteLocation(String(location._id))
        ).rejects.toThrow(AppError);
      });
    });
  });
  ...
  describe('Schedule Management', () => {
    ...
    describe('updateSchedule', () => {
      it('should update schedule successfully', async () => {
        ...
        const updatedSchedule = await AdminService.updateSchedule(String(schedule._id), updateData);
    ...
    describe('deleteSchedule', () => {
      it('should delete schedule successfully', async () => {
        ...
        await AdminService.deleteSchedule(String(schedule._id));
    ...
    describe('createBulkSchedules', () => {
      it('should create multiple schedules successfully', async () => {
        ...
        const schedules = [
          { locationId: String(location._id), dayOfWeek: 1, startTime: '09:00', endTime: '17:00' },
          { locationId: String(location._id), dayOfWeek: 2, startTime: '09:00', endTime: '17:00' },
          { locationId: String(location._id), dayOfWeek: 3, startTime: '09:00', endTime: '17:00' }
        ];

        const result = await AdminService.createBulkSchedules(String(location._id), schedules);
  ...
  describe('Booking Oversight', () => {
    ...
    describe('updateBookingStatus', () => {
      it('should update booking status with valid transition', async () => {
        ...
        const updatedBooking = await AdminService.updateBookingStatus(String(booking._id), 'CONFIRMED');
      ...
      it('should throw error for invalid status transition', async () => {
        ...
        await expect(
          AdminService.updateBookingStatus(String(booking._id), 'PENDING')
        ).rejects.toThrow(AppError);
      });
    });
  });
