...
function displayWebhookInfo(): void {
  ...
  console.log('  npx tsx scripts/test-email-simple.ts delivered@resend.dev');
  console.log('  npx tsx scripts/test-email-simple.ts bounced@resend.dev');
  console.log('  npx tsx scripts/test-email-simple.ts complained@resend.dev');
  console.log('');
