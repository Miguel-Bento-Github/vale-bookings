...
class AdminController {
  ...
  // Valet Management
  async getAllValets(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
  ...
  async createValet(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const valetData = {
        ...req.body,
  ...
  async updateValet(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const { id } = req.params;
  ...
  async deleteValet(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const { id } = req.params;
  ...
  async createBulkSchedules(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
  ...
  async getBookingAnalytics(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
